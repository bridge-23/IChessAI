...
import { idlFactory } from './chess23.did.js';
export { idlFactory } from './chess23.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CHESS23;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./chess23.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the chess23 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./chess23.did.js")._SERVICE>}
 */
export const chess23 = createActor(canisterId);
