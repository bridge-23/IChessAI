        ...
        <div className="flex flex-col items-center justify-center min-h-screen p-6">
            <div className="bg-white shadow-md rounded-lg p-8 w-full max-w-md text-center">
                ...
                <button
                    ...
                    //   disabled={shouldDisable} ${shouldDisable ? 'bg-gray-500 cursor-not-allowed' :
                    className="w-full px-4 py-2 mb-4 bg-blue-500 hover:bg-blue-600
            text-white rounded-md transition-colors duration-300"
                ...
                <button
                    ...
                    //   disabled={shouldDisable} ${shouldDisable ? 'bg-gray-500 cursor-not-allowed' : 
                    className="w-full px-4 py-2 mb-4 bg-green-500 hover:bg-green-600
        text-white rounded-md transition-colors duration-300"
                >
                    Player vs AI
                </button>
